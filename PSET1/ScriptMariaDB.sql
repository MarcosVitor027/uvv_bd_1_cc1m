...
CREATE USER marcosvitorIDENTIFIED BY '202203243';
...
ALTER TABLE cargos COMMENT 'Tabela cargos. Armazena informações sobre cada cargo na empresa.';

ALTER TABLE cargos MODIFY COLUMN id_cargo VARCHAR(10) COMMENT 'Chave primária da tabela. Usada pra identificarcada cargo.';

ALTER TABLE cargos MODIFY COLUMN cargo VARCHAR(35) COMMENT 'Chave única. Nome de cada cargo.';

ALTER TABLE cargos MODIFY COLUMN salario_minimo DECIMAL(8, 2) COMMENT 'O menor salário de cada cargo.';

ALTER TABLE cargos MODIFY COLUMN salario_maximo DECIMAL(8, 2) COMMENT 'O maior salário de cada cargo.';
...
ALTER TABLE regioes COMMENT 'Tabela regioes. Contém informações necessárias sobre  as regiões para a empresa.';

ALTER TABLE regioes MODIFY COLUMN id_regiao INTEGER COMMENT 'Chave primária da tabela regioes. Usada para identificar a região.';

ALTER TABLE regioes MODIFY COLUMN nome VARCHAR(25) COMMENT 'Chave única. Nome de cada região.';
...
ALTER TABLE paises COMMENT 'Tabela paises. Contém informações necessárias sobre  os países para a empresa.';

ALTER TABLE paises MODIFY COLUMN id_pais CHAR(2) COMMENT 'Chave primária da tabela países. Usada para identificar o país.';

ALTER TABLE paises MODIFY COLUMN nome VARCHAR(50) COMMENT 'Chave única. Nome do país.';
...
ALTER TABLE localizacoes COMMENT 'Tabela localizacoes. Contém informações necessárias sobre  as localizacoes para a empresa. Como por exemplo a localidade de cada endereço físico da empresa';

ALTER TABLE localizacoes MODIFY COLUMN id_localizacao INTEGER COMMENT 'Chave primária para tabela localizacao. Usada para identificar a localizacao.';

ALTER TABLE localizacoes MODIFY COLUMN endereco VARCHAR(50) COMMENT 'Endereço da empresa física.';

ALTER TABLE localizacoes MODIFY COLUMN cep VARCHAR(12) COMMENT 'CEP da  localização da empresa física.';

ALTER TABLE localizacoes MODIFY COLUMN cidade VARCHAR(50) COMMENT 'Cidade em que se localiza a empresa.';

ALTER TABLE localizacoes MODIFY COLUMN uf VARCHAR(25) COMMENT 'Estado em que se localiza a empresa.';

ALTER TABLE localizacoes MODIFY COLUMN id_pais CHAR(2) COMMENT 'Chave estrangeira para tabela paises.';
...
ALTER TABLE departamentos COMMENT 'Tabela com informações sobre os departamentos da empresa.';

ALTER TABLE departamentos MODIFY COLUMN id_departamento INTEGER COMMENT 'Chave primária da tabela departamentos. Usada pra identificar o departamento.';

ALTER TABLE departamentos MODIFY COLUMN nome VARCHAR(50) COMMENT 'Chave única. Nome de cada departamento na tabela.';

ALTER TABLE departamentos MODIFY COLUMN id_localizacao INTEGER COMMENT 'Chave estrangeira para tabela gerentes.';
...
ALTER TABLE empregados COMMENT 'Tabela que contém informações sobre cada funcionário. Contendo informações para contato se precisar.';
...
ALTER TABLE empregados MODIFY COLUMN email VARCHAR(35) COMMENT 'Chave única. Parte inicial do email do funcionário (antes do @).';

ALTER TABLE empregados MODIFY COLUMN telefone VARCHAR(20) COMMENT 'Telefone com DDD de cada funcionário.';

ALTER TABLE empregados MODIFY COLUMN data_contratacao DATE COMMENT 'Data em que o funcionário foi contratado.';

ALTER TABLE empregados MODIFY COLUMN id_cargo VARCHAR(10) COMMENT 'Chave estrangeira para tabela cargos. Mosta qual o cargo de determinado funcionário.';

ALTER TABLE empregados MODIFY COLUMN salario DECIMAL(8, 2) COMMENT 'Salário de cada funcionário. (Mensal)';

ALTER TABLE empregados MODIFY COLUMN comissao DECIMAL(4, 2) COMMENT 'Comissão em % que cada funcionário de vendas irá receber.';

ALTER TABLE empregados MODIFY COLUMN id_supervisor INTEGER COMMENT 'Chave estrangeira para para tabela empregados.  Indica o supervisor de cada empregado.';

ALTER TABLE empregados MODIFY COLUMN id_departamento INTEGER COMMENT 'Chave estrangeira para tabela departamentos. Indica em qual departamento está cada empregado.';
...
ALTER TABLE historico_cargos MODIFY COLUMN id_cargo VARCHAR(10) COMMENT 'Chave estrangeira para tabela cargos. Cargo em que o funcionário trabalhou no passado.';

ALTER TABLE historico_cargos MODIFY COLUMN id_departamento INTEGER COMMENT 'Chave estrangeira para tabela departamentos. É o departamento que o funcionário trabalhou no passado.';
